...
if __name__ == '__main__':
	...
	transition_space_base_A=[Coordinate(0,0),Coordinate(0,10),Coordinate(10,0)]
	transition_space_base_B=[Coordinate(0,0),Coordinate(0,10),Coordinate(10,0)]
	...
	assert np.all(np.isclose(space_A_point.tuple,base_B_point.tuple))#type: ignore
	...
	transition_space_base_A = [Coordinate(-2,7),Coordinate(5,12),Coordinate(1,6)]
	# in transition space, base_A_point should be (3, 9)
	
	temp = Coordinate(
		transition_space_base_A[0].x + 0.5 * (transition_space_base_A[1].x - transition_space_base_A[0].x) + 0.5 * (transition_space_base_A[2].x - transition_space_base_A[0].x),
		transition_space_base_A[0].y + 0.5 * (transition_space_base_A[1].y - transition_space_base_A[0].y) + 0.5 * (transition_space_base_A[2].y - transition_space_base_A[0].y)
	)
	print(temp)
	assert np.all(np.isclose(temp.tuple,(3, 9)))#type: ignore
	
	temp = anchor_translate(transition_space_base_A,A_space_base,space_A_point)
	print(temp)
	assert np.all(np.isclose(temp.tuple,(3, 9)))#type: ignore
	transition_space_base_B = [Coordinate(0,0),Coordinate(0,10),Coordinate(10,0)]
	B_space_base = [Coordinate(0,0),Coordinate(0,10),Coordinate(10,0)]
	...
	# back and forth
	A_space_base=[Coordinate(15,-23),Coordinate(18,-22),Coordinate(14,-22)]
	space_A_point=Coordinate(7,5)
	transition_space_base_A=[Coordinate(-1,2),Coordinate(-9,10),Coordinate(11,0)]
	B_space_base=[Coordinate(-1,9),Coordinate(-3,10),Coordinate(2,8)]
	transition_space_base_B=[Coordinate(0,21),Coordinate(0,10),Coordinate(10,0)]
	base_B_point=merge_coordinate(
		A_space_base,
		B_space_base,
		transition_space_base_A,
	...
	assert np.all(np.isclose(space_A_point.tuple,space_A_point2.tuple))#type: ignore